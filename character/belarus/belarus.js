...
function renderAbilities() {
  ...
  const { abilityScores, skills } = belarus;
...
function renderSpells() {
  ...
  let slotBlock = renderSpellSlots(belarus);
...
function renderClassAbilities() {
  ...
  const classAbilities = belarus.classAbilities;
...
function renderRaceAbilities() {
  ...
  const raceAbilities = belarus.raceAbilities;
