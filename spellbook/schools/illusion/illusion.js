...
function draw() {
    ...
    gradient.addColorStop(0, "#173630");
    gradient.addColorStop(0.5, "#0d1f1c");
...
function createSpellCard(spell) {
    ...
    <div class="flip-card-inner">
      ...
      <div class="flip-card-back illusion">
...
async function populateSpells() {
    const response = await fetch('/DnD-Wiki/spellbook/schools/illusion/illusion.json');
