...
function draw() {
    ...
    gradient.addColorStop(0, "#3a1031");
    gradient.addColorStop(0.5, "#20091c");
    gradient.addColorStop(1, "#0a0309");
...
function createSpellCard(spell) {
    ...
    <div class="flip-card-inner">
      ...
      <div class="flip-card-back transmutation">
...
async function populateSpells() {
    const response = await fetch('/DnD-Wiki/spellbook/schools/transmutation/transmutation.json');
