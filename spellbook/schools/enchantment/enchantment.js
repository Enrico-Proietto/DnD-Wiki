...
function draw() {
    ...
    gradient.addColorStop(0, "#10293a");
    gradient.addColorStop(0.5, "#0a1924");
...
function createSpellCard(spell) {
    ...
    <div class="flip-card-inner">
      ...
      <div class="flip-card-back enchantment">
...
async function populateSpells() {
    const response = await fetch('/DnD-Wiki/spellbook/schools/enchantment/enchantment.json');
