...
function draw() {
    ...
    gradient.addColorStop(0, "#331c0a");
    gradient.addColorStop(0.5, "#1f1206");
...
function createSpellCard(spell) {
    ...
    <div class="flip-card-inner">
      ...
      <div class="flip-card-back evocation">
...
async function populateSpells() {
    const response = await fetch('/DnD-Wiki/spellbook/schools/evocation/evocation.json');
