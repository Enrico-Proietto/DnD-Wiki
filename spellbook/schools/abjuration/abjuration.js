...
function draw() {
    ...
    gradient.addColorStop(0, "#3a1111");
    gradient.addColorStop(0.5, "#210909");
    gradient.addColorStop(1, "#0b0303");
...
function createSpellCard(spell) {
    ...
    <div class="flip-card-inner">
      ...
      <div class="flip-card-back abjuration">
...
async function populateSpells() {
    const response = await fetch('/DnD-Wiki/spellbook/schools/abjuration/abjuration.json');
