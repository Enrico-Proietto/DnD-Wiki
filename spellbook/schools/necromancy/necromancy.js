...
function draw() {
    ...
    gradient.addColorStop(0, "#0f3f34");
    gradient.addColorStop(0.5, "#092a23");
    gradient.addColorStop(1, "#031510");
...
function createSpellCard(spell) {
    ...
    <div class="flip-card-inner">
      ...
      <div class="flip-card-back necromancy">
...
async function populateSpells() {
    const response = await fetch('/DnD-Wiki/spellbook/schools/necromancy/necromancy.json');
